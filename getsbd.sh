...
fdm -v fetch
sudo /usr/bin/find "/home/root-gy/Mail/marlin" -type f -iname '*.sbd' -size 32c -exec /usr/bin/python3 "/home/root-gy/Mail/readmailsbd/unpack_weather.py" {} "/var/www/mail/marlin" \; -exec /usr/bin/mv {} /home/root-gy/Mail/marlin-archive \;
